...
@pytest.mark.asyncio
async def test_get_all_memory_topics_with_user_id_filter(async_mysql_db_real):
    ...
    alice_topics = await async_mysql_db_real.get_all_memory_topics(user_id="alice")
    assert set(alice_topics) == {"work", "python", "travel"}

    bob_topics = await async_mysql_db_real.get_all_memory_topics(user_id="bob")
...
@pytest.mark.asyncio
async def test_get_all_memory_topics_unknown_user_returns_empty(async_mysql_db_real):
    ...
    unknown_topics = await async_mysql_db_real.get_all_memory_topics(user_id="unknown_user")
...
async def test_get_all_memory_topics_tenant_isolation(async_mysql_db_real):
    ...
    alice_topics = set(await async_mysql_db_real.get_all_memory_topics(user_id="alice_iso"))
    bob_topics = set(await async_mysql_db_real.get_all_memory_topics(user_id="bob_iso"))
