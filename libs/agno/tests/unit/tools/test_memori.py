...
def test_init_default_config(memori_toolkit_default, mock_memori_instance, mock_memory_tool_instance):
...
def test_init_custom_config(memori_toolkit_custom, mock_memori_instance, mock_memory_tool_instance):
...
def test_init_with_connection_error(monkeypatch):
...
def test_search_memory_success(memori_toolkit_default, mock_memory_tool_instance, dummy_agent):
    """Test successful memory search."""
    result_str = memori_toolkit_default.search_memory("Python programming")
...
def test_search_memory_with_limit(memori_toolkit_default, mock_memory_tool_instance, dummy_agent):
    """Test memory search with limit parameter."""
    result_str = memori_toolkit_default.search_memory("Python", limit=1)
...
def test_search_memory_empty_query(memori_toolkit_default, dummy_agent):
    """Test memory search with empty query."""
    result_str = memori_toolkit_default.search_memory("   ")
...
def test_search_memory_no_results(memori_toolkit_default, mock_memory_tool_instance, dummy_agent):
    """Test memory search with no results."""
    mock_memory_tool_instance.execute.return_value = None

    result_str = memori_toolkit_default.search_memory("nonexistent query")
...
def test_search_memory_exception(memori_toolkit_default, mock_memory_tool_instance, dummy_agent):
    """Test memory search with exception."""
    mock_memory_tool_instance.execute.side_effect = Exception("Search failed")

    result_str = memori_toolkit_default.search_memory("test query")
...
def test_record_conversation_success_with_session_messages(memori_toolkit_default, mock_memori_instance, dummy_agent):
    """Test successful conversation recording using session messages."""
    result_str = memori_toolkit_default.record_conversation("User likes Python")
...
def test_record_conversation_success_with_run_response_fallback(
    memori_toolkit_default, mock_memori_instance, dummy_agent
):
...
def test_record_conversation_empty_content(memori_toolkit_default, dummy_agent):
    """Test record conversation with empty content."""
    result_str = memori_toolkit_default.record_conversation("   ")
...
def test_record_conversation_exception(memori_toolkit_default, mock_memori_instance, dummy_agent):
    """Test record conversation with exception."""
    mock_memori_instance.record_conversation.side_effect = Exception("Recording failed")

    result_str = memori_toolkit_default.record_conversation("Test content")
...
def test_get_memory_stats_success(memori_toolkit_default, mock_memori_instance, dummy_agent):
    """Test successful memory stats retrieval."""
    result_str = memori_toolkit_default.get_memory_stats()
...
def test_get_memory_stats_no_method(memori_toolkit_default, mock_memori_instance, dummy_agent):
...
def test_get_memory_stats_method_exception(memori_toolkit_default, mock_memori_instance, dummy_agent):
...
def test_get_memory_stats_general_exception(memori_toolkit_default, mock_memori_instance, dummy_agent):
...
def test_enable_memory_system_success(memori_toolkit_default, mock_memori_instance):
...
def test_enable_memory_system_exception(memori_toolkit_default, mock_memori_instance):
...
def test_disable_memory_system_success(memori_toolkit_default, mock_memori_instance):
...
def test_disable_memory_system_no_method(memori_toolkit_default, mock_memori_instance):
...
def test_disable_memory_system_exception(memori_toolkit_default, mock_memori_instance):
...
def test_toolkit_tools_registration(memori_toolkit_default):
...
def test_create_memori_search_tool(memori_toolkit_default, mock_memory_tool_instance):
...
def test_create_memori_search_tool_empty_query(memori_toolkit_default):
...
def test_create_memori_search_tool_no_results(memori_toolkit_default, mock_memory_tool_instance):
...
def test_create_memori_search_tool_exception(memori_toolkit_default, mock_memory_tool_instance):
