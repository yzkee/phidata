Goal: Clean up and standardize `cookbook/92_integrations` so all Python examples pass the structure checker.
...
Note: This directory contains integration-specific examples. Do NOT migrate model classes
