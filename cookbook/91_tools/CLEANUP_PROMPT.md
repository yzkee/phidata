Goal: Clean up and standardize `cookbook/91_tools` so all Python examples pass the structure checker.
...
Note: This directory contains tool-specific examples. Do NOT migrate model classes
