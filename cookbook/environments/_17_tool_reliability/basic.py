"""
Tool Reliability - Basic
========================

Require the agent to compute a validation code and execute the submission tool
with that exact value. A tool call with a plausible but wrong code does not pass.
"""
