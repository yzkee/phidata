...
```shell
python cookbook/90_models/vertexai/claude/db.py
```
...
```shell
python cookbook/90_models/vertexai/claude/knowledge.py
```

### 10. Run Agent that uses memory

```shell
python cookbook/90_models/vertexai/claude/memory.py
```
...
```shell
python cookbook/90_models/vertexai/claude/thinking.py
```
